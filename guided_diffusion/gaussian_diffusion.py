...
class GaussianDiffusion:
    ...
    def p_sample_loop(
        ...
        """
        Generate samples from the model for several timesteps.
    ...
    def training_losses(self, model, x_start, t, model_kwargs=None, noise=None):
        ...
        noise, x_t = self.q_sample(x_start, t, noise=noise)
    ...
    def calc_bpd_loop(self, model, x_start, clip_denoised=True, model_kwargs=None):
        ...
        for t in list(range(self.num_timesteps))[::-1]:
            ...
            noise, x_t = self.q_sample(x_start=x_start, t=t_batch)
...
def _extract_into_tensor(arr, timesteps, broadcast_shape):
    """
    Extract values from a 1-D numpy array (or torch Tensor) for a batch of indices.
    ...
    # both np and th supported now
    arr = arr if isinstance(arr, th.Tensor) else th.from_numpy(arr)
